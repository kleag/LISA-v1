...
cp $model_dir/parse_preds.tsv $model_dir/parse_preds-conll2005-lstm-dev24.tsv
...
cp $model_dir/parse_preds.tsv $model_dir/parse_preds-conll2005-lstm-test-brown.tsv
