...
train_file=$data_dir/nw_conll2012-train.txt.bio
...
dm_valid_file=lstm_predicted_parses_elmo_nw/parse_preds-conll2012-lstm-dev.tsv.replaced
dm_test_file=lstm_predicted_parses_elmo_nw/parse_preds-conll2012-lstm-test.tsv.replaced
