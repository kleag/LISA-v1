                                                ...
                                                for parents_layer in ${parents_layers[@]}; do
                                                    for predicate_layer in ${predicate_layers[@]}; do
                                                        for rep in `seq $reps`; do
                                                            fname_append="$rep-$lr-$mu-$nu-$epsilon-$warmup_steps-$batch_size-$cnn_dim-$trans_layer-$num_head-$head_size-$relu_hidden_size-$parents_penalty-$parents_layer-$predicate_layer"
                                                            multitask_layer=""
